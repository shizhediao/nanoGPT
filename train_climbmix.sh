...
submit_job --gpu 8 --nodes 32 --account llmservice_fm_vision --partition backfill,batch --notify_on_start --duration 4 -n nanogpt-climbmix --autoresume_before_timelimit 10 --image /lustre/fsw/portfolios/nvr/users/sdiao/docker/megatron_py25.sqsh --command ''"${cmd}"'' 
