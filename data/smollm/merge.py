...
if __name__ == "__main__":
    ...
    # 这里列出你要合并的三个文件
    input_files = [
        os.path.join(data_dir, "cosmopedia-v2_train.bin"),
        os.path.join(data_dir, "python-edu_train.bin"),
        os.path.join(data_dir, "fineweb-edu-dedup_train.bin")
    ]
    ...
    # 可选: 同样合并验证集
    val_input_files = [
        os.path.join(data_dir, "cosmopedia-v2_val.bin"),
        os.path.join(data_dir, "python-edu_val.bin"),
        os.path.join(data_dir, "fineweb-edu-dedup_val.bin")
    ]
